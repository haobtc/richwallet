...
module.exports.bytesToBase64 = function(bytes) {
		...
		if (typeof btoa == "function") return btoa(Crypto.charenc.Binary.bytesToString(bytes));
...
module.exports.base64ToBytes = function(base64) {
		// Use browser-native function if it exists
		if (typeof atob == "function") return Crypto.charenc.Binary.stringToBytes(atob(base64));
