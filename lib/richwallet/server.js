	      ...
	      if(response == true) {
			...
			if(!req.body.payload.emailActiveCode) {
			  ...
			  if (req.body.payload.action == "register") {
				...
				var content = '<p>hello:</p><p>thank you for your register,click the following link to finish:</p><p><a href="' + link + '">' + link + '</a></p><p>if the link cannot be clicked, please copy it into the browser and enter the register web.</p><p>(this email is auto generated, please do not reply)'
